...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl font-semibold font-['Comic_Sans_MS']">Craftlab</h1>
        <a href="/add-post" class="bg-black hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg">Add Post</a>
    </div>
</header>
