...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="contianer mx-auto px-4  flex justify-between items-center">
        <h1 class="text-2xl font-bold font=['Comic_Sans_MS']">Craftlab</h1>
        <a href="/add-post"class ="bg-blue-500 hober:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add post</a>
    </div>
</header>
