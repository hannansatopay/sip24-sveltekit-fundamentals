...
<form class="container mx-auto p-5 bg-white shadow-lg rounded-lg" method="post" enctype="multipart/form-data">
    ...
    <div class="flex space-x-2 mb-3">
        <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg " on:click={greyscale}>Greyscale</button>
        <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg " on:click={sepia}>Sepia</button>
        <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg " on:click={resetFilter}>Reset</button>
    </div>

    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Share</button>
</form>