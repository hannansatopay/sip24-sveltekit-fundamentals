...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl text-pink-900 font-bold font-['Comic_Sans_MS']">Instagram Clone</h1>
        <a href="/" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Home</a>
    </div>
</header>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="text-white bg-purple-500 hover:bg-purple-800 font-medium rounded-lg text-sm px-5 py-2.5">Share</button>
</form>