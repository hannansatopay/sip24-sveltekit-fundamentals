    ...
    <label for= "dropzone" class= "mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <svg class="w-8 h-8 mb-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7l1.646-1.646a1 1 0 011.414 0L9 7m0 0l2.94 2.94a1 1 0 001.415 0L15 7m0 0l2.646-2.646a1 1 0 011.414 0L21 7M9 17v-4a3 3 0 013-3h0a3 3 0 013 3v4m-6 0a2 2 0 11-4 0h4zm10 0a2 2 0 11-4 0h4z"/>
            </svg>
