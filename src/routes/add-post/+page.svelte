...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="container1">
        <div class="mb-3">
            <canvas bind:this={canvas} class="border border-gray-300 w-70 h-70"></canvas>
        </div>
        <div class="mb-3">
            <button type="button" class="text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2" on:click={() => applyFilter('grayscale')}>Grayscale</button>
            <button type="button" class="text-white bg-yellow-700 hover:bg-brown-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2" on:click={() => applyFilter('sepia')}>Sepia</button>
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2" on:click={() => applyFilter('invert')}>Invert</button>
            <button type="button" class="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click={() => applyFilter('brightness')}>Brightness</button>
        </div>
    </div>
