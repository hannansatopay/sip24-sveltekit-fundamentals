...
<header class="bg-white py-4 shadow-md sticky top-0">
    <div class="container mx-auto px-4 flex justify-between items-center">
       ...
       <a href="/" class="bg-black hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg">Home</a>
    </div>
</header>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <button type="submit" class="bg-black hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg">Share</button>
</form>