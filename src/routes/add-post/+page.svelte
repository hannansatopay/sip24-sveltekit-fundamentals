...
<div
  class="p-5 max-w-[425px] container grid grid-cols-1 items-center mx-auto my-5  rounded-lg"
>
  <label
    for="dropzone"
...
>
  ...
  <div class="flex flex-col gap-1">
    ...
    <input
      type="text"
      class="bg-gray-100 border border-black rounded-lg w-full h-8 px-3 py-1 times-new-roman"
      id="username"
      name="username"
      required
    />
  ...
  <div class="flex flex-col gap-1">
    ...
    <textarea
      type="text"
      class="bg-gray-100 border border-black rounded-lg w-full h-12 py-1 px-3 times-new-roman"
      id="content"
      name="content"
      required
    />
  ...
  <br />
  <button
    class="bg-blue-500 hover:bg-blue-700 text-white rounded font-bold py-2 px-4"
    >POST</button
  >
</form>
