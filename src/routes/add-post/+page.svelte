...
<header class="bg-white py-4 shadow-md sticky top-0">
    <div class="container mx-auto px-4 flex justify-between items-center">
       <h1 class="text-2xl font-bold ">InstaFam</h1>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50"> 
        <div class="flex flex-col items-center justify-center pb-6">
            ...
            {:else}
                ...
                <p class="text-sm text-gray-500 font-semibold">Click Here To Uplaod A Photo</p>
            {/if}                    
        </div>
    ...
    <div class="mb-3">
        <label for="content" class="block mb-2 font-medium text-gray-900">Caption</label>
    ...
    <button type="submit" class="text-white bg-gradient-to-r from-purple-500 to-purple-900 font-medium rounded-lg px-5 py-2.5">Post</button>
</form>
