...
<script>
  ...
  <header class="p-4 shadow-md sticky top-0 z-10" style="background-color: #FFFAF0;">
    <div class="container mx-auto px-4 flex justify-between items-center">
      ...
      <a href="/" class="text-white font-bold py-2 px-4 rounded" style="background-color: #09CAF0;">Home</a>
    </div>
  </header>
  <form class="container mx-auto p-5 my-8 w-10/12 md:w-6/12 bg-green-50 rounded-lg shadow-md" method="POST" enctype="multipart/form-data" style="background-color: #FFFAF0;">
    ...
    <div class="flex justify-center">
      <button type="submit" class="w-60 text-white font-medium rounded-lg text-sm px-5 py-2.5" style="background-color: #09CAF0;">POST</button>
    </div>
  </form>  