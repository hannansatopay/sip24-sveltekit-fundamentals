...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-400 border-dashed rounded-lg cursor-pointer bg-gray-50"> 
   ...
   <div class="mb-3">
    ...
    <button type="submit" class="text-white bg-gray-600 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-1">Share</button>
</form>