...
<div class="flex flex-col items-center">
    <form class="container mx-auto p-5 flex flex-col items-center" method="POST" enctype="multipart/form-data">
        <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full max-w-md h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
