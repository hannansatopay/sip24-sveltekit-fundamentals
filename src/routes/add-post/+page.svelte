...
<header class="py-4 bg-gradient-to-r from-purple-800 to-orange-600 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="font-bold text-2xl font-['Lucida_Handwriting']">Craftlab</h1>
        <a href="/" class="bg-blue-700 rounded-3xl text-white hover:bg-blue-800 py-2 px-4 font-bold">Home</a>
    </div>
</header>

<form class="container mx-auto p-5 bg-white rounded-lg mt-6" method="POST" enctype="multipart/form-data">
...
<div>
    <h1 class="font-['Comic_Sans_MS'] flex justify-center">Preview</h1>
</div>
...
<div class=" mt-2 container mx-auto w-60 h-60 rounded-lg flex justify-center">
