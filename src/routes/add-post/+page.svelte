...
<header class="bg-white py-4 shadow-md sticky top-0 x-10">
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data"> 
    <!-- <input type="file"> -->
    <!-- <div> -->
        <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h64 border-2 border-gray-3">
