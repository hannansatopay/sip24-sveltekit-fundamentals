...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <a href="/" class="bg-slate-700 hover:bg-slate-900 text-white font-bold py-2 px-4 rounded">Home</a>
    </div>
</header>
 <form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
        ...
        <div class="w-2/3">
            ...
            <div class="flex space-x-2 mb-3">
                <button type="button" class="text-white bg-slate-700 hover:bg-slate-900 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-300" on:click="{() => applyFilter('grayscale')}">Grayscale</button>
                <button type="button" class="text-white bg-slate-700 hover:bg-slate-900 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-300" on:click="{() => applyFilter('sepia')}">Sepia</button>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="text-white bg-slate-700 hover:bg-slate-900 font-medium rounded-lg text-sm px-5 py-2.5">Share</button>
        </div>
    </div>
    </form> 
