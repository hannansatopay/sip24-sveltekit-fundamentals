...
<form action="" class=" container mx-auto p-5" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input name ="username" id ="username" type="text" class="bg-gray-70 border border-gray-300 text-gray-900 text-sm rounded-lg block">
    </div>
     <div class="mb-3">   
        <label for="content" class="block mb-2 text-sm font-medium text-gray-900">Content</label>
        <textarea name ="content" id ="content" type="text" class="bg-gray-70 border border-gray-300 text-gray-900 text-sm rounded-lg block"></textarea>
    </div>

    <button type ="submit" class="text-white bg-blue-700 hover:bg-blue-900 font-medium rounded-lg text-sm px-5 py-2">Share Post</button>
