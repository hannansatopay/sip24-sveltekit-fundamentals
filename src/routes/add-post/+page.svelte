...
<div class="border-wrapper">
    <header class="shadow bg-gray-100 sticky top-0">
        <div class=" container mx-auto flex px-4 justify-between items-center">
            <h1 class="font-serif text-3xl font-bold py-3">InstaApp</h1>
            <a href="/" class="bg-blue-300 rounded-lg px-4 py-2">Home</a>
        </div>
    </header>
    ...
    <form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="bg-blue-300 rounded-lg px-4 py-2 mb-10">Share</button>
    </form>
</div>
