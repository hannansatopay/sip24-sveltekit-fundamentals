...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold font-['Comic_Sans_MS']">Sansinsta</h1>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="filter-buttons flex justify-between mb-1">
        ...
        <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 py-2.5 ml-2" on:click="{() => applyFilter('grayscale')}">Grayscale</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 py-2.5 ml-2" on:click="{() => applyFilter('sepia')}">Sepia</button>
