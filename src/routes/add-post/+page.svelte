...
<form class="container mx-auto p-5 my-8 w-10/12 md:w-7/12 bg-green-50 rounded-lg shadow-md" method="POST" enctype="multipart/form-data" style="background-color: #F0FFF0;">
