...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
            {#if files && files.length}
                ...
                <!-- <canvas id="myCanvas" width="full" height="64"></canvas>
                <script>
    ...
    <div class="flex justify-between mb-3">
        <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click="{() => applyFilter('grayscale')}">Grayscale</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click="{() => applyFilter('sepia')}">Sepia</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click="{resetImage}">Reset</button>
    </div>
    <div class="mb-3">
