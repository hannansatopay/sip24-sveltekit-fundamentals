    ...
    function handleFileUpload(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                files = [file]; // Store the file object in files array
            };
...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold" style="font-family: 'Comic Sans MS', cursive;">Craftlab</h1>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
        <div class="flex flex-col items-center pt-5 pb-6">
            {#if imageUrl}
                <img src="{imageUrl}" alt="Selected Image" class="w-full h-48 object-cover mb-2 rounded-lg" />
