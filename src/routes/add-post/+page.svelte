...
<form class="container mx-auto p-5" method="post" enctype="multipart/form-data">
  <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300">
    <div class="flex flex-col items-center justify-center pt-5 pb-6">
      {#if files && files.length}
        ...
        {:else}
            <svg class="w-8 h-8 mb-4 text-gray-500" fill="none" xmlns="http://www.w3.org/2000/svg">
            </svg>
  ...
  <div>
    <label for="username" class="block mb-2 text-sm font-medium text-black-900">Username</label>
