<!-- <h1>Welcome, Glad you wanna contribute to our community!</h1> -->
<script>
    let files = null;
...
<header class="bg-white py-4 shadow-md sticky top-2 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        ...
        <a href="/" class="font-bold text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 border-radius-5 rounded">Home</a>
    </div>
</header>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <!-- <button type="submit" class="text-white bg-green-500 px-5 py-2.5 rounded font-bold hover:bg-green-600">Share!</button> -->
