...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
  <div class="w-full flex h-auto justify-between">
    <label for="dropzone" class="upload-label mb-3 flex flex-col items-center w-1/3 justify-center h-auto border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover-effect">
    ...
    <div class="filter-container mb-3 w-1/2">
