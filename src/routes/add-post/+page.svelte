...
<header class="bg-whitr py-4 shadow-md sticky top-0 z-10">
...
<form class=" container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <label for="dropzone" class="md-3 flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg  cursor-pointer bg-gray-50">
    ...
    <div class="mb-3">
        <label for="username" class="block mb-2 text-sm font-medium text-gary-900">Username</label>
    ...
    <div class="mb-3">
        <label for="content" class="block mb-2 text-sm font-medium text-gary-900">Content</label>
    ...
    <button type="submit" class="bg-blue-700 hover:bg-blue-800 text-white font-medium  rounded-lg text-sm px-5 py-2.5">Share</button>
</form>