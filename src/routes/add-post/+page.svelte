...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="test-2xl font-bold font-['Comic_Sans_MS']">Craftlab</h1>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <textarea name="content" id="content" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounder-lg block w-full p-2.5"></textarea>
    </div>
