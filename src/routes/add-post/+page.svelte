...
<header class="bg-white py-4 shadow-md sticky top-0 z-10">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h1 class="text-2xl font-bold font-['Comic_Sans_MS']">Craft lab</h1>
        <a
            href="/"
            class="text-white bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 rounded-lg"
            >Home</a
        >
    </div>
</header>
...
<form class="container mx-auto p-5" method="post" enctype="multipart/form-data">
    ...
    <input
        type="hidden"
        name="filteredImageData"
        id="filteredImageData"
        bind:value={filteredImageData}
    />
    <button
        type="button"
        class="text-white bg-blue-500 hover:bg-blue-800 font-bold py-2 px-4 rounded-lg"
        on:click={greyscale}>Greyscale</button
    >
    <button
        type="button"
        class="text-white bg-blue-500 hover:bg-blue-800 font-bold py-2 px-4 rounded-lg"
        on:click={sepia}>sepia</button
    >
    <button
        type="button"
        class="text-white bg-blue-500 hover:bg-blue-800 font-bold py-2 px-4 rounded-lg"
