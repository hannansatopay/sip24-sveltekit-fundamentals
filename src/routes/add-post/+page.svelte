...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <button type="button" class="text-white bg-yellow-700 hover:bg-brown-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click={() => applyFilter('sepia')}>Sepia</button>
    </div>
