...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data" id="formData">
    ...
    <button type="submit" class="text-white bg-blue-500 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5">Share</button>
</form>