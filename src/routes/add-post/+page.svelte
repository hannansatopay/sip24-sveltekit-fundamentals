...
<div class="container mx-auto p-5">
    ...
    <div class="mb-4 flex justify-center">
        <button type="button" on:click={() => resetImage()} class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">Reset</button>
        <button type="button" on:click={() => applyFilter('grayscale')} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2">Grayscale</button>
