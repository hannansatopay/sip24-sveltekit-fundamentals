...
<header class="shadow-md shadow-gray-600 sticky z-10 bg-white top-0 w-full">
    <div class="flex flex-row justify-between items-center py-2 px-3 font-mono">
        ...
        <a href="/" class="bg-blue-500 px-2 py-1 rounded-lg text-white font-bold hover:scale-105 hover:shadow-md hover:shadow-gray-300">Home</a>
    </div>
</header>
    ...
    <label
        ...
        <div class="flex flex-col items-center justify-center p-20">
            {#if files && files.length != 0}
                ...
                <p>{files[0].name}</p>
            {:else}
                <svg class="w-8 h-10 mb-0.5 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/></svg>
...
<form class="p-5 max-w-[425px] container grid grid-cols-1 items-center mx-auto my-5 bg-gray-200 rounded-lg" method="POST" enctype="multipart/form-data" id="postForm" name="postForm">
