...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="canvas-container mb-3">
        <canvas id="imageCanvas" class="border border-gray-300 rounded-lg"></canvas>
    </div>
    <div class="mb-3 flex gap-2">
        <button type="button" class="text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click={applyGrayscale}>Grayscale</button>
        <button type="button" class="text-white bg-yellow-700 hover:bg-yellow-800 font-medium rounded-lg text-sm px-5 py-2.5" on:click={applySepia}>Sepia</button>
    </div>
    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5">Share</button>
</form>
