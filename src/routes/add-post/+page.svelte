...
<form class="container mx-auto p-5 bg-white shadow-lg rounded-lg" method="post" enctype="multipart/form-data">
    ...
    <div class="flex space-x-2 mb-3">
        <button type="button" class="text-white bg-blue-500 hover:bg-indigo-600 font-bold py-2 px-4 rounded-lg shadow transition duration-300" on:click={greyscale}>Greyscale</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-indigo-600 font-bold py-2 px-4 rounded-lg shadow transition duration-300" on:click={sepia}>Sepia</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-indigo-600 font-bold py-2 px-4 rounded-lg shadow transition duration-300" on:click={blur}>Blur</button>
        <button type="button" class="text-white bg-blue-500 hover:bg-indigo-600 font-bold py-2 px-4 rounded-lg shadow transition duration-300" on:click={resetFilter}>Reset</button>
    </div>
