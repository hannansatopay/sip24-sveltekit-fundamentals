...
<header class="px-4 m-auto container shadow-lg">
    <div class="container flex justify-between items-center align-middle">
        <div class="font-bold text-4xl p-2">
            Instagram
        </div>
        <a href="/" class="border-2 border-black h-10 px-6 font-bold rounded-lg grid place-items-center ">Home</a>
    </div>
</header>
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input name="location" id="location" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
    </div>
    <div class="mb-3">
